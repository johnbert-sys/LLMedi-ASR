...
const settingUpdaters: {
  ...
  active_dictionaries: (value) =>
    commands.updateActiveDictionaries(value as string[]),
  context_dictionaries: (value) =>
    commands.updateContextDictionaries(value as string[]),
